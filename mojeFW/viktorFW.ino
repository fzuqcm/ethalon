...
const POLY_DEGREE = 5;
BLA::Matrix<POLY_DEGREE, SWEEP_COUNT> A_dagger;
BLA::Matrix<SWEEP_COUNT, POLY_DEGREE> A;
double quad_res;
double res;
...
double sweepFrequency(long rf)
{
  ...
  double result = rf - (SWEEP_RANGE / 2) + i*(double)SWEEP_STEP;
